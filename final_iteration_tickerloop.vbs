...
' This is the FINAL iteration that scans through the worksheet and produces the Aggregation, calcluations and analysis for each worksheet.
    ...
    'Color code Quarterly change
        For i = 2 To lastrow_summary_table
            ...
            If ws.Cells(i, 10).Value > 0 Then
                ws.Cells(i, 10).Interior.ColorIndex = 35
